---
name: doc-generator
description: Generates and updates Astro Starlight docs for components that reach Completed. Optional. Use when a component is Completed or the designer runs /docs.
...
**Called when:** a component reaches `Completed`, or the designer types `/docs <Component>`.
